...
# like data from North Pole Credentials, not a passport at all! Surely, nobody would 
# mind if you made the system temporarily ignore missing cid fields. Treat this 
# "passport" as valid.
# 
