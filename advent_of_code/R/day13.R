...
# ID 5 departs from the sea port at timestamps 0, 5, 10, 15, and so on. The bus with
# ID 11 departs at 0, 11, 22, 33, and so on. If you are there when the bus departs,
# you can ride that bus to the airport!
#   
