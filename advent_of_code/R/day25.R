...
#   They even created all the room keys this morning; you can take yours now
# and give them your room deposit once the registration system comes back online.
# 
...
# Still catching your breath, you describe the status of the elevator and the exact
# number of stairs you just had to climb.
# 
...
# a subject number. To transform a subject number, start with the value 1. 
...
# a little trial and error, you can work out that the card's loop size must be 8,
...
# of 17807724 (the door's public key) with a loop size of 8 (the card's loop size)
