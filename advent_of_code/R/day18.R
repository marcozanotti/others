...
# of addition (+), multiplication (*), and parentheses ((...)). Just like normal 
# math, parentheses indicate that the expression inside must be evaluated before 
# it can be used by the surrounding expression. Addition still finds the sum of 
# the numbers on both sides of the operator, and multiplication still finds the 
# product.
# 
