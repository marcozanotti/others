...
# be flipped over (your puzzle input). Each line in the list identifies a single
...
# are given in your list, respectively, as e, se, sw, w, nw, and ne. A tile
# is identified by a series of these directions with no delimiters; for example,
